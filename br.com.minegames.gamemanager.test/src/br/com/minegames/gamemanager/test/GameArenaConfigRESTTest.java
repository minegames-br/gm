...
public class GameArenaConfigRESTTest {

	public static void main(String args[]) {

        String jsonString;
        GameManagerDelegate delegate = GameManagerDelegate.getInstance("http://localhost:8080/gamemanager/webresources/");
        List<GameArenaConfig> gacs = delegate.listGameArenaConfig();
        for(GameArenaConfig gac: gacs) {
        	System.out.println(gac.getGa_config_uuid().toString());
        }
